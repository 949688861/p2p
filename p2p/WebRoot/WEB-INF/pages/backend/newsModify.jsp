...
<body style="padding: 5px 10px">
	...
	<div class="panel panel-primary">
	  ...
	  <div class="panel-body">
	  		<form class="form-horizontal" role="form" action="${pageContext.request.contextPath }/news/modify" method="post" enctype="multipart/form-data" onsubmit="return check();">
            
            <div class="form-group">
              <label for="newsId" class="col-lg-2 control-label">新闻编号</label>
              <div class="col-lg-10">
                <input type="text" class="form-control" id="newsId" name="newsId"  value="${news.newsId }"  readonly="readonly"/>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-lg-10">
                <input type="text" class="form-control" id="newsName" name="newsTitle" value="${news.newsTitle }" placeholder="新闻标题" onfocus="remname();">
			...
			<div class="btn-toolbar" data-role="editor-toolbar"	data-target="#content">
				...
				<div class="btn-group">
		 		...
		 		<div class="btn-group">
					...
					<textarea rows="3" cols="50" id="content" name="content" style="overflow:scroll; max-height:300px;border: 1px solid;height: 200px;" onfocus="remcont();">${news.content }</textarea>
                        ...
                        <div class="fileupload fileupload-new" data-provides="fileupload">
                            <div class="input-group">
                                 <div class="fileupload-new thumbnail" style="width: 130px; height: 139px;">
                                     <img src=" ${pageContext.request.contextPath}/images/${news.image}"  alt=""/>
                                 </div>
