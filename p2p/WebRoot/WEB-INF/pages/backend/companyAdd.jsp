...
<body style="padding: 5px 10px">
	...
	<div class="panel panel-primary">
	  ...
	  <div class="panel-body">
	  		...
	  		<form class="form-horizontal" role="form" action="${pageContext.request.contextPath }/company/add" method="post" onsubmit="return check();">
	  		
            <div class="form-group">
              <label for="companyName" class="col-lg-2 control-label">企业名称</label>
              <div class="col-lg-10">
                <input type="text" class="form-control" id="companyName" name="companyName" placeholder="产品名称"  onfocus="remname();">
            ...
            <div class="form-group">
            	...
            	<div class="col-lg-10">
			        <div class="input-group col-lg-3" style="float: left;">
			            <input type="text" class="form-control" id="financinginreturn" name="financingInReturn" placeholder="佣金数" onfocus="remreturn();">
...
<!--               	asdalksdjklasj -->
           ...
           <textarea rows="3" cols="50" id="content" name="companyDetail" style="overflow:scroll; max-height:300px;border: 1px solid;height: 200px;" onfocus="remdetail();"></textarea>
        	 <br/><label id="detail" style="color: red"></label>
         </div>
     </div>
